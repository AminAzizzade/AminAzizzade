...
| **Backend & DB** | **Frontend / Mobile** | **Data / Infra** |
| :--- | :--- | :--- |
| Java, Spring Boot, JPA | React.js, React Native | Apache Spark, Kafka, Flink |
| SQL, Relational DB Design | Kotlin, Jetpack Compose | Hadoop, Docker, Hive |
